...
>
> **Map ke materi kuliah**: [Skenario 7 — Dashboard Monitoring Surat Real-Time](../../../materi-kuliah-2025-struktur-data/case-study-aplikasi-surat-kecamatan.md). "Jumlah surat masuk dalam 1 jam terakhir... 24 jam terakhir... Top 5 pengirim dalam 7 hari... Update cepat, memori sedikit, estimasi cukup."
