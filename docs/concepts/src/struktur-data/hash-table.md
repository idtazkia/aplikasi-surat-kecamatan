...
> **Map ke materi kuliah**: [Skenario 6 Bagian B — Deteksi Duplikat Instan](https://github.com/endymuhardin/materi-kuliah-2025-struktur-data/blob/main/case-study-aplikasi-surat-kecamatan.md). "Pengecekan ini terjadi setiap kali staf klik Simpan — tidak boleh lambat meski database sudah berisi 50.000 surat... Apa kunci yang kamu pakai untuk lookup?"
>
